...
public class Column3Adapter extends RecyclerView.Adapter<Column3Adapter.ViewHolder> {
    ...
    public Column3Adapter(Context mContext, List<Page> mData) {
    ...
    @Override
    public void onBindViewHolder(Column3Adapter.ViewHolder holder, final int position) {
        // 데이터
